...
public class QwertySlLayout extends FullLayout {

	private static String mId = KeyboardApp.getApp().getString(R.string.kb_id_qwerty_sl);

	private final String[] adjacentKeys = {"asš","bnv","cčćvx","dđsšf","erw","fdđg","gfh","hgj","iuo","jhk","kjl","lk","mn","nmb","oip","po","qw","ret","sšadđ","trzž","uzži","vcčćb","weq","xcčćy","ytu","zžx"};
	private final String[] surroundingKeys = {"asšqw","bhnv","cčćvfx","dđersšfx","esšrdđw","frtdđgcčć","gfhzžtv","hzžugjb","iuokj","juihkn","kiomjl","lopk","mnk","njbm","oiplk","pol","qaw","retfdđ","sšadđewy","trzžgf","uzžijh","vgcčćb","wesšqa","xcčćdđy","yuthg","zžsšx"};
