...
//		Crittercism.leaveBreadcrumb("KeyboardView.setShiftKeyIcon(" + capsLock + "," + redraw + ")");
	...
	protected void drawLabel(Key key, Canvas canvas, Rect kbPadding, Rect keyPadding) {
		...
		mPaint.setTextAlign(Paint.Align.CENTER);
		// For characters, use large font. For labels like "Done", use small
		// font.
...
//		Crittercism.leaveBreadcrumb("KeyboardView.updateKeyIcon(" + key.codes[0] + ")");
...
//		Crittercism.leaveBreadcrumb("KeyboardView.updateAnyKeySym()");
