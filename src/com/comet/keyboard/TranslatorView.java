...
public class TranslatorView extends RelativeLayout implements View.OnClickListener {
		...
		public void handleMessage(Message result) {
			...
			if(translator.error == Translator.RESULT_ERROR) {
				...
				if(!translator.translation.equals("")) {
					KeyboardService.getIME().commitText(translator.translation);
	...
	protected void onCreate() {
		...
		// Assign a listener to buy more button
		findViewById(R.id.tvBuyMore).setOnClickListener(this);
...
//		findViewById(R.id.img_voice_input).setOnClickListener(this);
		...
		View viewCredits = findViewById(R.id.llTransPoint);
		
		if(!creditsShowing())
			viewCredits.setVisibility(View.INVISIBLE);
	...
	public void onClick(View view) {
		...
		else if(view == view.findViewById(R.id.tvBuyMore))
			onClickBuyMore();
...
//			onClickTranslateVoiceInput();
    ...
    public void onUpdateUI() {
		...
		// Update purchased point
		TextView tvPurchasedPoint = (TextView) findViewById(R.id.tvRemainedPoint);
		String purchasedPoint = String.format(getResources().getString(R.string.purchase_trans_point_description),
				getCredits());
		tvPurchasedPoint.setText(purchasedPoint);
    }
