...
import com.comet.keyboard.util.HttpLogSender;
...
//	/**
//	 * Updates the current language. If necessary, it downloads a new language
//	 * and prompts for a keyboard.
//	 * 
//	 * @param language	A language code.
//	 */
//	public void onLanguageChange(final String language) {
//
//		if (language.equals(getResources().getString(R.string.lang_code_other))) {
//			
//			// User selected "other" language. Notify him no suggestions will be provided.
//			mLangNoticeDialog = new AlertDialog.Builder(this).create();
//			mLangNoticeDialog.setTitle(R.string.install_select_language_notice_title);
//			mLangNoticeDialog.setMessage(getResources().getString(R.string.settings_language_notice));
//			// mAlertDialog.setIcon(R.drawable.icon);
//			mLangNoticeDialog.setButton(DialogInterface.BUTTON_POSITIVE,
//					getResources().getString(R.string.install_select_language_notice_ok),
//					new DialogInterface.OnClickListener() {
//						public void onClick(DialogInterface dialog, int which) {
//							mLangNoticeDialog.dismiss();
//							updateCurrentLanguage(language);
//						}
//					});
//			mLangNoticeDialog.show();
//		} else {
//			// Check if a new dictionary needs to be downloaded.
//			DictionaryUpdater updater = KeyboardApp.getKeyboardApp().getUpdater();
//			DictionaryItem mDicItem = updater.getDictionaryItem(language);
//
//			if (DictionaryUpdater.isDictionaryExist(this, mDicItem)) {
//				updateCurrentLanguage(language);
//				return;
//			}
//
//			// Start download dictionary
//			Intent intent = new Intent();
//			Bundle bundle = new Bundle();
//			bundle.putBoolean(IN_SETTINGS, true);
//			intent.putExtra(BUNDLE_KEY, bundle);
//			intent.setClass(this, LanguageSelector.class);
//
...
//					String currLangPrefix = LanguageSelector.getLanguagePreference(Settings.this);
//					DictionaryItem dicItem = KeyboardApp.getKeyboardApp().getUpdater().getDictionaryItem(currLangPrefix);				
//					
//					if (dicItem != null && !dicItem.isNeedUpdate) {
//						// Create or update the language profile.
//						updateCurrentLanguage(dicItem.lang);
//
//						// Set install step to final.
//						Installer.setCurrStep(Settings.this,
...
//					}
//					
//					KeyboardApp.getKeyboardApp().checkNeedUpdate(Settings.this);
//				}
//			});
...
//	/**
//	 * Persists the new keyboard to the language profile db. Updates the
//	 * keyboard preference summary.
//	 */
//	private void onKeyboardChange(String keyboard) {
//		SharedPreferences sharedPrefs = getSharedPreferences(Settings.SETTINGS_FILE, Context.MODE_PRIVATE);
//		String lang = sharedPrefs.getString("language", getResources().getString(R.string.lang_code_default));
//		
//		// Save to prefs
//		sharedPrefs.edit().putString("keyboard", keyboard).commit();
//		// Set current keyboard
//		KeyboardLayout.setCurrentLayout(keyboard);
...
//	/**
//	 * Called after the language changes. Checks if there a profile for this
//	 * language: if there isn't, it prompts user to select a keyboard. If there
//	 * is, updates the current keyboard.
//	 * 
//	 * @param language	The new language.
//	 */
//	private void updateCurrentLanguage(String language) {
//		LanguageProfileManager manager = LanguageProfileManager.getProfileManager();
//		LanguageProfile profile = manager.getProfile(language);
//		if(profile == null) {
//			// This profile is incomplete. Prompt for a keyboard layout.
//			Intent intent = new Intent();
//			Bundle bundle = new Bundle();
//			bundle.putBoolean(IN_SETTINGS, true);
//			intent.putExtra(BUNDLE_KEY, bundle);
//			intent.setClass(this, KeyboardSelector.class);
//			startActivityForResult(intent, REQ_KEYBOARD_LAYOUT);
//
//			return;
//		}
//
//		// Set the current language profile
//		manager.setCurrentProfile(language);
//
//		// Update the UI
//		ListPreference lp = (ListPreference) findPreference("keyboard");
//		lp.setValue(profile.getKeyboard());
//		updateLabels();
//	}
}
