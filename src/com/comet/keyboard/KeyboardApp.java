...
import com.comet.keyboard.purchase.UpgradeApp;
...
//		android.os.Debug.waitForDebugger();
    ...
    public void onUpgrade() {
		Intent intent = new Intent(this, UpgradeApp.class);
     ...
     */
	public void upgrade() {
		// Update product type and license
		setProductType(getString(R.string.upgrade_product_type));
		getLicenseClient().updateLicenseAsync();
	}
}
